...
public class ImageByLocGroupAdapter extends RecyclerView.Adapter<ImageByLocGroupAdapter.ViewHolder> {
    ArrayList<String> arrayListGroup;
    Context context;
    public ImageByLocGroupAdapter(ArrayList<String> arrayListGroup, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        try {
            arrayListMem = listOfImageByLoc.listOfImageByLocation(context, arrayListGroup.get(position));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ImageByLocMemberAdapter memAdap = new ImageByLocMemberAdapter(arrayListMem, context);
